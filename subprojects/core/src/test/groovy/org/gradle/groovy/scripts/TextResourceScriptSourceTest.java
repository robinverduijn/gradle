...
public class TextResourceScriptSourceTest {
    ...
    private ScriptSource forFile(File scriptFile) {
        return new TextResourceScriptSource(TextResourceLoader.forFile("<file-type>", scriptFile));
    }

    private ScriptSource forUri(URI scriptFileUri) {
        return new TextResourceScriptSource(TextResourceLoader.forUri("<file-type>", scriptFileUri));
    }
